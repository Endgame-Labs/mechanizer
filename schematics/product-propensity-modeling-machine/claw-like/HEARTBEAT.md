...
alert_channels:
  - "slack:#rev-intel-alerts"
  - "email:revint-oncall@example.com"

lock:
  strategy: advisory_or_lease_lock
  key: "claw.product_propensity_modeling"
...
dead_letter:
  enabled: true
  sink: "dlq.product-propensity-modeling"
  max_receive_count: 5

hitl:
  required_for: "crm_writeback, seller_alert_send, audience_sync, outbound_send"
...
safe_mode:
  ...
  diagnostics_event: "product.propensity.machine.safe_mode"

stale_handling:
  stale_event: "product.propensity.machine.stale"
