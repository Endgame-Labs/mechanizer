...
## Purpose
Build weekly pipeline intelligence summaries and prioritized actions with deterministic scoring and approval-gated distribution.
...
Summary distribution and CRM mutation suggestions require HITL approval before execution.
