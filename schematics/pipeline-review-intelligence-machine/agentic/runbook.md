# Agentic Runbook (pipeline-review-intelligence-machine)
...
- Required before manager/executive distribution and CRM writeback actions.
- Decision envelope: approve/reject/edit with evidence-preserving edits only.
- Reject or timeout emits deferred review-prep terminal event.
...
## Terminal Events
- pipeline.review.prep.completed
- pipeline.review.prep.deferred
- pipeline.review.prep.failed_validation
- pipeline.review.prep.failed
