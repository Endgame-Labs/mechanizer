# Agentic Runbook (account-plan-generation-machine)
...
- Required before plan publication to CRM or external channels.
- Decision envelope: approve/reject/edit; edit limited to plan sections and priority values.
- Reject or timeout emits blocked outcome and stores plan draft for manual follow-up.
