# Agentic Runbook (new-hire-ramp-accelerator-machine)
...
- Required for external communications and profile mutations.
- Decision envelope: approve/reject/edit; edits require re-evaluation before execution.
- Reject or timeout emits ramp guidance blocked event without side effects.
...
## Terminal Events
- ramp.guidance.created
- ramp.guidance.blocked
- ramp.guidance.failed
