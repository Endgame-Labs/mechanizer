...
dead_letter:
  enabled: true
  sink: "dlq.new-hire-ramp-accelerator"
  max_receive_count: 5

hitl:
  required_for: "hris_profile_write, external_manager_email_send"
...
safe_mode:
  ...
  diagnostics_event: "ramp.machine.safe_mode"

stale_handling:
  stale_event: "ramp.machine.stale"
