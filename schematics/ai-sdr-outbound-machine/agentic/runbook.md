# Agentic Runbook (ai-sdr-outbound-machine)
...
- Required for sequence activation and CRM writeback.
- Decision envelope: approve/reject/edit; edit is constrained to approved templates and claims.
- Reject or timeout emits sdr.sequence.blocked; responses may still route without activating new outbound actions.
