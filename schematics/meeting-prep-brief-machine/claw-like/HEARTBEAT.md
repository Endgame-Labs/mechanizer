...
dead_letter:
  enabled: true
  sink: "dlq.meeting-prep-brief"
  max_receive_count: 5

hitl:
  required_for: "executive_email_send, slack_brief_delivery"
...
safe_mode:
  ...
  diagnostics_event: "meeting.prep_brief.machine.safe_mode"

stale_handling:
  stale_event: "meeting.prep_brief.machine.stale"
