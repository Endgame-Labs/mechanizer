# Agentic Runbook (meeting-prep-brief-machine)
...
- Required for executive-brief delivery and any external email send.
- Decision envelope: approve/reject/edit; edits are section-scoped (asks, risks, talking points).
- Reject or timeout emits meeting.prep_brief.blocked and suppresses delivery channels.
