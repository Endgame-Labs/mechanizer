...
## Purpose
Assemble deterministic pre-meeting briefs from calendar, CRM, and interaction context with policy-safe delivery controls.
...
Email or Slack delivery for executive or high-severity meetings requires HITL approval.
