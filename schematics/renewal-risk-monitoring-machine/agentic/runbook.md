# Agentic Runbook (renewal-risk-monitoring-machine)
...
- Required for external customer messaging and CRM mutations.
- Decision envelope: approve/reject/edit with policy-safe edit constraints.
- Reject or timeout emits renewal risk blocked outcome.
...
## Terminal Events
- renewal.risk.executed
- renewal.risk.blocked
- renewal.risk.failed
