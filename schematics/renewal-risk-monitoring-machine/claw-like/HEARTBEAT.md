...
lock:
  ...
  key: "claw.renewal_risk_monitoring"
...
dead_letter:
  enabled: true
  sink: "dlq.renewal-risk-monitoring"
  max_receive_count: 5

hitl:
  required_for: "customer_email_send, crm_task_write, playbook_state_change"
...
safe_mode:
  ...
  diagnostics_event: "renewal.risk.machine.safe_mode"

stale_handling:
  stale_event: "renewal.risk.machine.stale"
