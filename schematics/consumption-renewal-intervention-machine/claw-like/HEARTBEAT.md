...
lock:
  ...
  key: "claw.consumption_renewal_intervention"
...
dead_letter:
  enabled: true
  sink: "dlq.consumption-renewal-intervention"
  max_receive_count: 5

hitl:
  required_for: "customer_email_send, crm_renewal_plan_write"
...
safe_mode:
  ...
  diagnostics_event: "renewal.intervention.machine.safe_mode"

stale_handling:
  stale_event: "renewal.intervention.machine.stale"
