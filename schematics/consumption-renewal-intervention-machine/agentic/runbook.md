# Agentic Runbook (consumption-renewal-intervention-machine)
...
- Required before outreach send, CRM update, or renewal-plan task creation.
- Decision envelope: approve/reject/edit with safe-template constraints.
- Reject or timeout emits intervention blocked outcome with remediation guidance.
...
## Terminal Events
- renewal.intervention.executed
- renewal.intervention.blocked
- renewal.intervention.failed
