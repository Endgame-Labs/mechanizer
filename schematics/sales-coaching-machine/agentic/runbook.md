...
- Required when alignment score is below auto-write threshold or when recommendation implies high-risk claims.
- Decision envelope: approve/reject/edit; edits trigger re-evaluation pass.
- Reject or timeout emits blocked outcome and skips CRM and notification writes.
...
- coaching.recommendation.blocked
- coaching.recommendation.failed
