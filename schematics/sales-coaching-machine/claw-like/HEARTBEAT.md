...
dead_letter:
  enabled: true
  sink: "dlq.sales-coaching"
  max_receive_count: 5

hitl:
  required_for: "crm_task_create, outbound_manager_email_send"
...
safe_mode:
  ...
  diagnostics_event: "sales.coaching.machine.safe_mode"

stale_handling:
  stale_event: "sales.coaching.machine.stale"
