# Agentic Runbook (account-health-audit-machine)
...
- This machine primarily emits audit events; direct write actions are disabled by default.
- If enabled, treat mutation actions as high-risk and require approve/reject/edit.
- On deny or timeout, emit blocked or deferred audit-action event without mutations.
...
## Terminal Events
- account.health.audit.completed
- account.health.audit.blocked
- account.health.audit.failed_validation
- account.health.audit.failed
