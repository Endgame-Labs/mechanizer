...
2. Runner acquires non-blocking distributed lock (claw.deal_hygiene); if lock exists, mark skipped_overlap and exit.
...
- Cadence note: 15-minute cadence catches stale deals quickly without saturating CRM APIs.
- Cursor lookback: 45m
...
- Emit diagnostics event: deal.hygiene.machine.safe_mode
