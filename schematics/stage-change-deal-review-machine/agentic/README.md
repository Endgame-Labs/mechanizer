...
## Purpose
Review stage-change events for qualification integrity and perform approval-gated remediation/writeback actions.
...
CRM stage-field writebacks and external findings distribution require HITL approval.
