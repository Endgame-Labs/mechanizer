...
lock:
  ...
  key: "claw.stage_change_deal_review"
...
dead_letter:
  enabled: true
  sink: "dlq.stage-change-deal-review"
  max_receive_count: 5

hitl:
  required_for: "crm_stage_writeback, external_findings_send"
...
safe_mode:
  ...
  diagnostics_event: "deal.stage_review.machine.safe_mode"

stale_handling:
  stale_event: "deal.stage_review.machine.stale"
